...
Guias curtos e focados em tarefas para itens específicos que os pilotos
costumam querer configurar, em contraste com a referência aba por aba em
[Configuração do modelo](../model-setup/index.md).
...
- [Curva de compensação ajustável em voo](in-flight-compensation-curve.md)
- [Retomada instantânea para a função Trainer](instant-takeback.md)
- [Encontrar o bootloader mais recente ou outro componente](find-latest-bootloader.md)
