...
en particular, qué módulo de RF utiliza un modelo (interno o externo) es un
ajuste por modelo dentro de [Sistema RF](../model-setup/rf-system.md), no
aquí.

Toque un icono para abrirlo, o desplace el resalte con el selector
rotativo y pulse `ENT`. Existe una segunda página de iconos — deslice hacia la izquierda, mueva el
resalte hasta ella o pulse `PAGE` para cambiar.

- [Gestor de archivos](file-manager.md) — archivos y carpetas, y actualización del
  firmware del módulo de RF interno, dispositivos S.Port, OTA y módulos
  externos.
- [Alertas](alerts.md) — modo silencioso, batería de la emisora/RTC, conflicto de sensores
...
- [Hardware](hardware.md) — comprobación y calibración de los controles
  físicos, definición del tipo de interruptores y asignación de teclas de inicio.
- [Controles](controls.md) — modo de sticks y orden de canales por defecto (aparece como
  "Sticks" en el menú).
