...
- **Hauptspannung** — zeigt den aktuellen Messwert an und dient zugleich der
  ...
  gemessene Spannung ein. Standardwert ist 8,4 V (ein voll geladener
  2S-Li-Ion-Akku).
- **Niedrige Spannung** — die Alarmschwelle, standardmäßig 7,2 V (7,4 V bietet
  ...
  !!! warning
      ...
      Sender bedingungslos ab, um die 2×3,0-V-Li-Ion-Zellen zu schützen.

- **Anzeigebereich der Spannung** — Minimum/Maximum für die grafische
...
- **RTC-Spannung** — die Spannung der Knopfzelle für die Echtzeituhr. Im Neuzustand
  3,0 V; unterhalb von 2,7 V sollte sie ersetzt werden, damit die Uhr genau
  bleibt, und unterhalb von 2,5 V ist mit der [RTC-Spannungswarnung](alerts.md)
  zu rechnen.
