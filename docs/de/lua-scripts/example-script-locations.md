...
konfigurieren](../displays/custom-widgets.md)); das Beispiel **`servo`**
demonstriert speziell ein **System-Tool** — ein Skript, das im System-Menü nach
...
3. Rechtsklick auf die Seite → **Seite speichern unter…**, und speichern Sie sie
   als `main.lua`.
...
Skripte werden auf der SD card/eMMC unter `scripts/` installiert — siehe
