...
Currently the following external FrSky modules are supported: XJT Lite, R9M Lite, R9M Lite Access, R9M Lite Pro Access, TWIN Lite Pro and PPM. For third party modules please refer to the next section.
...
The External RF Module can operate in PPM mode.
