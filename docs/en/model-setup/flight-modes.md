...
The default flight mode FM0 is inactive until configured. Tap on the ‘+’ button to add a new flight mode. There may be up to 20 flight modes per model.
...
Tap on a flight mode to bring up a menu which allows you to edit, move, clone or delete flight modes. New flight modes may be added by tapping on the ‘+’ button in the heading.
