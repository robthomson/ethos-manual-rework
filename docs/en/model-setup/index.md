...
Custom curves can be used in input formatting, in the mixes or in the channel outputs. There are 50 curves available, and can be of several types (between 2 and 21 point, with either fixed or user-definable x-coordinates).
...
In the Channels section a balancing curve may be used to ensure accurate tracking of the left and right flaps.
