...
The Bluetooth screen will display again.
...
At connection, the radio will automatically enter ‘Ethos mode’ for communication with Ethos Suite. Please refer to [Ethos Mode](../ethos-suite/operation.md) in the Ethos Suite section.
