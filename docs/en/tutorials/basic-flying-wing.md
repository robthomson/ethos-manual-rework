...
Please read through the next two sections on reviewing your mixes and configuring the Outputs before proceeding. To avoid damage by inadvertently over-driving your servos, it would be wise to disconnect your servo linkages or reduce the servo travel until you are ready to configure the servo min/max limits.

## Step 6. Review the Mixes

You can use the Outputs screen to review the mixes. Output channels 1 and 2 may be renamed to Elevon1 and Elevon2.
