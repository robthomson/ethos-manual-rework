...
We will also need to add additional mixes for Gyro Gain and Rescue/Stabi. Tap on a mixer line and select ‘Add Mix’ to add the extra channels needed using Free Mixes:
...
Tap on a mixer line and select ‘Add Mix’ to add the extra channel needed using a Free Mix. Add it after the last channel.
