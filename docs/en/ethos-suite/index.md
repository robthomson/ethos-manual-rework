...
!!! note "Screenshots pending"
    Ethos Suite is a separate PC application, not the radio itself, so
    this section doesn't use the simulator-captured screenshots the rest
    of the manual does — see [Screenshot
