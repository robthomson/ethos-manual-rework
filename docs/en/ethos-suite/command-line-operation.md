...
Ethos Suite can be run from a terminal command line.

The following command line options are available:

| --help | help text for the Ethos Suite command line tool. |
| --- | --- |
| --version | show the version of the installed Ethos Suite. |
