...
- **Memoria** — una eMMC interna da 8GB di serie (è possibile aggiungere anche una SD card esterna), come sui modelli X20 Pro/R/RS — vedi [Configurazione di sistema →
...
- **Trim aggiuntivi** — come sui modelli X20 Pro/R/RS, aggiunge gli interruttori di trim **T5** e
