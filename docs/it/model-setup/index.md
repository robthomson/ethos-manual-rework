...
- [Selezione modello](model-select.md) — creazione, scelta e organizzazione
  dei modelli.
- [Modifica modello](model-edit.md) — nome, tipo e icona del modello.
- [Fasi di volo](flight-modes.md)
- [Mix](mixes.md) — il cuore della programmazione del modello.
- [Uscite](outputs.md) — fine corsa di servi/motori, subtrim e inversione.
- [Timer](timers.md)
- [Trim](trims.md)
- [Sistema RF](rf-system.md) — binding del ricevitore e configurazione del
  modulo RF.
- [Curve](curves.md)
- [Interruttori logici](logical-switches.md)
- [Funzioni speciali](special-functions.md)
- [Variabili](variables.md)
- [Trainer](trainer.md)
- [Telemetria](telemetry.md) — rilevamento dei sensori e sensori calcolati.
