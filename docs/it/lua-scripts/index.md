...
Gli script Lua permettono di creare [widget di visualizzazione](../displays/custom-widgets.md)
personalizzati per mostrare informazioni non gestite nativamente da Ethos e, per
ciascun modello, [sorgenti e task](../model-setup/lua-scripts.md) personalizzati —
una base destinata a crescere ulteriormente, verso funzioni personalizzate
specializzate e l'integrazione con le centraline di volo.
...
proprio per questo tipo di personalizzazione a bordo radio.
...
!!! warning
    ...
    male può invece ritardare l'avvio quasi indefinitamente.

- [Interprete Lua](lua-interpreter.md) — quale versione di Lua e quali librerie
  sono integrate in Ethos.
- [Documentazione Lua di Ethos](ethos-lua-documentation.md) — dove si trova il
