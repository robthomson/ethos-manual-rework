...
- **Formato 24 ore** — commuta l'orologio tra la visualizzazione a 12 e 24 ore.
- **Mostra secondi** — aggiunge i secondi alla visualizzazione dell'orologio.
- **Data** / **Ora** — imposta la data/ora corrente; entrambe vengono utilizzate
  per la registrazione dei dati.
- **Fuso orario** — il fuso orario locale.
...
- **Regolazione automatica da GPS** — se attivata, imposta automaticamente data e ora
  utilizzando invece i dati di un sensore GPS remoto.
