...
针对飞手常见的具体设置需求，提供简短、以任务为导向的指南；与[模型设置](../model-setup/index.md)中逐标签页的参考说明不同。
...
- [飞行中可调补偿曲线](in-flight-compensation-curve.md)
- [教练功能的即时收回控制权](instant-takeback.md)
- [查找最新的 Bootloader 或其他组件](find-latest-bootloader.md)
